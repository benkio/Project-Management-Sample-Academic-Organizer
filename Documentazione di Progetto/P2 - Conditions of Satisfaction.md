...
-------
 ...
 3. Gestione degli stati di una lezione, quindi possibilita' di cambiare stato a piu' lezioni contemporaneamente. In particolare si deve uno stato specifico chiamato *Pubblicato* il quale indica che la lezione non e' piu modificabile, a meno di utenti con un ruolo particolare (*Amministratore*) e che la lezione viene direttamente pubblicata nell'orario pubblico di ateneo (si veda il requisito sotto elencato).
